...
const CartDrawerProduct = ({ cartProduct }) => {
      ...
      <div className="card-body py-0">
        ...
        <div className="flex items-center justify-between">
          <select
            ...
            className="px-4 py-1 outline-none max-w-xs border border-gray-300 rounded-badge"
          >
            <option disabled defaultValue={quantity}>
              {quantity}
            </option>
            <option>1</option>
            <option>2</option>
